...
public class SignUpTests : IDisposable
{
    ...
    public SignUpTests(SpirebyteApplicationIntegrationFactory<Program> factory)
    {
    ...
    public async Task signup_command_fails_when_user_with_email_alreadt_exists_in_database()
    {
        ...
        // Add user
        var user = new User(id, email, fullname, "test.nl/image", password, role, securityStamp, 0, DateTime.MinValue,
            DateTime.UtcNow,
            new string[] { });
