...
public class GetUsersByIdsTests : IDisposable
{
    ...
    public GetUsersByIdsTests(SpirebyteApplicationIntegrationFactory<Program> factory)
    {
    ...
    public async Task get_users_by_ids_query_can_filter_based_on_ids_when_a_user_exists()
    {
        ...
        var user1 = new User(id1, email1, filterFullname, pic, password, role, securityStamp, 0, DateTime.MinValue,
            DateTime.UtcNow,
            new string[] { });
        var user2 = new User(id2, email2, filterFullname, pic, password, role, securityStamp, 0, DateTime.MinValue,
            DateTime.UtcNow,
            new string[] { });
    ...
    public async Task get_users_by_ids_query_should_return_empty_when_no_users_with_specified_ids_exist()
    {
        ...
        var query = new GetUsersByIds(new[] { Guid.NewGuid() });
    ...
    public async Task get_users_by_ids_query_should_return_empty_when_no_users_exist()
    {
        ...
        var query = new GetUsersByIds(new[] { id });
